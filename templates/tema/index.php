...
?>
<?php if ($this->params->get('font_url') != ''): ?>
<link href="<?php echo htmlspecialchars($this->params->get('font_url')); ?>" rel="stylesheet">
<?php endif; ?>
...
<?php endif; ?>
<style type="text/css">
<?php if ($this->params->get('font_family') != '' || $this->params->get('font_selectors') != ''): ?>
<?php echo htmlspecialchars($this->params->get('font_selectors')); ?> {font-family: '<?php echo htmlspecialchars($this->params->get('font_family')); ?>', sans-serif !important; font-weight:300;}
<?php endif; ?>
</style>
</head>
